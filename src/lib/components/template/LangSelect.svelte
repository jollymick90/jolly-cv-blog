...
<div>
	...
	<div class="relative">
	  <div class="inline-flex divide-x divide-indigo-700 rounded-md outline-none">
		...
		<button 
			type="button"
		 	class="inline-flex items-center rounded-l-none rounded-r-md
			 bg-indigo-600 p-2 outline-none
			  hover:bg-indigo-700 focus-visible:outline
	  ...
	  -->
	  <ul 
	  class="{showPopover ? 'absolute' : 'hidden'} right-0 z-10 mt-2 w-72 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black/5 focus:outline-none" tabindex="-1" role="listbox" aria-labelledby="listbox-label" aria-activedescendant="listbox-option-0">
		<!--

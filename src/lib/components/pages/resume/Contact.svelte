...
<div class="text-center flex flex-row gap-1 justify-center mt-4 text-lg text-gray-500  dark:text-zinc-100 leading-8">
    <div
    ...
    >
        <Icon class="-ml-1 mr-2 h-5 w-5 text-gray-400" aria-hidden="true" 
        src="{Envelope}" />
